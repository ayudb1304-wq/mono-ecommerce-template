...
/** Placeholder stack. Swap for real trip photos, or leave it as the teaser for /photos. */
const images = [
  { src: "/images/mono-1.png", alt: "Trip photo 1" },
  { src: "/images/mono-2.png", alt: "Trip photo 2" },
  { src: "/images/mono-3.png", alt: "Trip photo 3" },
  { src: "/images/mono-4.png", alt: "Trip photo 4" },
];
...
export function GallerySection() {
  ...
  // Start expanding when the last image is mostly stacked, finish at end of section
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex items-center justify-center px-4">
        ...
        {/* Upload CTA, fades in once the stack is complete */}
        <div
          className="pointer-events-none absolute inset-x-0 bottom-12 z-20 flex flex-col items-center gap-4 px-6 text-center"
          style={{ opacity: easedFullscreenProgress }}
        >
          <p className="text-lg text-white md:text-2xl">
            Everything anyone shoots ends up here.
          </p>
          <Link
            href="/photos"
